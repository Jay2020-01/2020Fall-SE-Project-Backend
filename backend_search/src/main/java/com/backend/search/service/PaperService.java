...
public class PaperService {
	...
	public Page<Paper> findPaperByKeywords(String keywords,Integer start_year,Integer end_year ,Integer pageNum, Integer pageSize) {
		return paperDao.findPaperByKeywords(keywords, start_year,end_year,pageNum, pageSize);
	}
}
